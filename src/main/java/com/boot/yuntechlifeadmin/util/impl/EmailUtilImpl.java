...
public class EmailUtilImpl implements EmailUtil {
    ...
    @Override
    public boolean sendEasyMail(String to, String title, String msg) throws IOException {
    ...
    @Override
    public boolean sendYuntechFlowWarn(String to, String title, String ip, double insUp, double insDown, double extUp, double extDown, double flow, double ratio, double warnValue) throws IOException {
