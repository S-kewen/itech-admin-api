...
public class HttpUtilImpl implements HttpUtil {
    @Override
    public String get(String url, MultiValueMap<String, String> params) throws IOException {
    ...
    @Override
    public String post(String url, MultiValueMap<String, String> params) throws IOException {
        SimpleClientHttpRequestFactory requestFactory = new SimpleClientHttpRequestFactory();
        requestFactory.setConnectTimeout(20 * 1000);
        requestFactory.setReadTimeout(20 * 1000);
        RestTemplate client = new RestTemplate(requestFactory);
