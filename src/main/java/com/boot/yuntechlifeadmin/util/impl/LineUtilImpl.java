...
public class LineUtilImpl implements LineUtil {
    ...
    @Override
    public boolean pushMessage(String to, String type, String text) throws IOException {
