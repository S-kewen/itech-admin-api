...
public class YuntechFlowSetController {
    ...
    public Map<String, Object> listYuntechFlowSet(int pageNumber, int pageSize, String sortName, String sortOrder, String keyword, int state, String startTime, String endTime) throws ParseException {
        ...
        if (token != null) {
            ...
            List<YuntechFlowSet> select=yuntechFlowSetService.getList(adminUser);;
    ...
    public Map<String, Object> deleteYuntechFlowSet(int id,boolean deleted) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            ...
            yuntechFlowSet.setDeleted(deleted);
    ...
    @LoginToken
    @RequestMapping("batchDeleteYuntechFlowSet")
    public Map<String, Object> batchDeleteYuntechFlowSet(int []  ids,boolean deleted) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            YuntechFlowSet yuntechFlowSet = new YuntechFlowSet();
            yuntechFlowSet.setIds(ids);
            yuntechFlowSet.setDeleted(deleted);
            int count = yuntechFlowSetService.deleteMore(yuntechFlowSet);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
    ...
    public Map<String, Object> changeYuntechFlowSetState(int id,int state) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
    ...
    @LoginToken
    @RequestMapping("batchUpdateYuntechFlowSetState")
    public Map<String, Object> batchUpdateYuntechFlowSetState(int []  ids,int state) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            ...
            yuntechFlowSet.setIds(ids);
            yuntechFlowSet.setState(state);
            int count = yuntechFlowSetService.updateMore(yuntechFlowSet);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
