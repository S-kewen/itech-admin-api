...
public class RechargeRecordController {
    ...
    public Map<String, Object> listRechargeRecord(int pageNumber, int pageSize, String sortName, String sortOrder, String keyword, int state,String startTime, String endTime) throws ParseException {
        ...
        if (token != null) {
            ...
            List<RechargeRecord> select=rechargeRecordService.getList(adminUser);;
            PageInfo<RechargeRecord> pageInfo = new PageInfo<>(select);
            map.put("status", 0);
            map.put("tip", "success");
    ...
    public Map<String, Object> deleteRechargeRecord(int id,boolean deleted) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            ...
            rechargeRecord.setDeleted(deleted);
            int count = rechargeRecordService.deleteOne(rechargeRecord);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
    ...
    @LoginToken
    @RequestMapping("batchDeleteRechargeRecord")
    public Map<String, Object> batchDeleteRechargeRecord(int []  ids,boolean deleted) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            RechargeRecord rechargeRecord = new RechargeRecord();
            rechargeRecord.setIds(ids);
            rechargeRecord.setDeleted(deleted);
            int count = rechargeRecordService.deleteMore(rechargeRecord);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
    ...
    @LoginToken
    @RequestMapping("changeRechargeRecordState")
    public Map<String, Object> changeRechargeRecordState(int id,int state) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            ...
            int count = rechargeRecordService.updateOne(rechargeRecord);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
    ...
    @LoginToken
    @RequestMapping("batchUpdateRechargeRecordState")
    public Map<String, Object> batchUpdateRechargeRecordState(int []  ids,int state) {
        Map<String, Object> map = new HashMap<>();
        Token token = new Token();
        token = tokenService.parseToken(request.getHeader("Authorization"));
        if (token != null) {
            ...
            rechargeRecord.setIds(ids);
            rechargeRecord.setState(state);
            int count = rechargeRecordService.updateMore(rechargeRecord);
            if (count > 0) {
                map.put("status", 0);
                map.put("tip", "success");
                map.put("count",count);
